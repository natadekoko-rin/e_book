...
Color backgroundColor = Color.fromARGB(255, 186, 173, 173);
...
Color devideColor = Color(0xFF6B6B6B);
...
TextStyle mediumText12 =
    GoogleFonts.poppins(color: devideColor, fontSize: 12, fontWeight: medium);
